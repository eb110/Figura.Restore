...
export const catalogApi = createApi({
    ...
    endpoints: (builder) => ({
        fetchProducts: builder.query<{ items: Product[], pagination: Pagination }, ProductParams>({
            ...
            //get the headers from response => by usage of 'meta'
...
//there is a 'lazy' version of these functions as well. Non 'lazy' version works as
//useEffect when 'lazy' waits for user trigger - by button press for example
